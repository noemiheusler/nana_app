...
invitation_3 = Invitation.create!(user_id: (User.all.last.id - 9) , event_id: (Event.all.last.id - 2))
invitation_4 = Invitation.create!(user_id: (User.all.last.id - 8) , event_id: (Event.all.last.id - 1))
